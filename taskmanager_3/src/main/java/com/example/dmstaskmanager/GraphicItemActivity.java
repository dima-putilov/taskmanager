...
public class GraphicItemActivity extends AppCompatActivity {
    ...
    EditText etDate, etSumma, etSummaCredit, etSummaProcent;
    ...
    public void onClickAdd(View v) {
        ...
        double summa, summa_credit, summa_procent;
        summa= summa_credit= summa_procent= 0;
        ...
        PAYMENT pay = new PAYMENT(credit_id, date, summa, summa_credit, summa_procent,0,0,0);

        if (payment_id>0) {
            pay._id = payment_id;
            db.graphic_Update(pay);
        }
        else
            db.graphic_Add(pay);
