...
class VerticalScrolledView: ScrollView {
...
//            return true // super.onInterceptTouchEvent(ev);
        ...
        Log.d("SCROLL", "ScrollView onInterceptTouchEvent = $res")

        //Log.d("SCROLL", "ScrollView gestureDetector = ${gestureDetector!!.onTouchEvent(ev)}")
   ...
   override fun onTouchEvent(ev: MotionEvent?): Boolean {
       ...
       Log.d("SCROLL", "ScrollView onTouchEvent = $res")
...
//    }
    ...
    internal class VerticalScrollDetector : GestureDetector.SimpleOnGestureListener() {
        ...
        override fun onScroll(e1: MotionEvent?, e2: MotionEvent?, distanceX: Float,
            ...
            Log.d("SCROLL", "ScrollView distanceY = $distanceY  distanceX =$distanceX")
